...
void config_disc_GPIO(){
	...
	CONFIG_DISC(SPIKE1_DISC_GPIO_GROUP, SPIKE1_DISC_DOWN_PIN);
    												/* Maoz 2 */
	/*Configure GPIO pin : PC6 PA5 PA6 */
	CONFIG_DISC(SPIKE2_DOWN_DISC_GPIO_GROUP, SPIKE2_DISC_DOWN_PIN);
	...
	CONFIG_DISC(SPIKE3_DISC_GPIO_GROUP, SPIKE3_DISC_DOWN_PIN);
													/* Maoz 4 */
	/*Configure GPIO pin : PC6 PA5 PA6 */
	CONFIG_DISC(SPIKE4_DISC_GPIO_GROUP, SPIKE4_DISC_UP_PIN);
	CONFIG_DISC(SPIKE4_DISC_GPIO_GROUP, SPIKE4_DISC_MID_PIN);
	CONFIG_DISC(SPIKE4_DISC_GPIO_GROUP, SPIKE4_DISC_DOWN_PIN);
}
...
void config_elev_GPIO(){
  ...
  HAL_GPIO_WritePin(SPIKE_1_GPIO_GROUP, SPIKE_1_UP_GPIO_PIN, GPIO_PIN_RESET);
  HAL_GPIO_WritePin(SPIKE_2_GPIO_GROUP, SPIKE_2_UP_GPIO_PIN, GPIO_PIN_RESET);
  HAL_GPIO_WritePin(SPIKE_3_GPIO_GROUP, SPIKE_3_UP_GPIO_PIN, GPIO_PIN_RESET);
  HAL_GPIO_WritePin(SPIKE_4_GPIO_GROUP, SPIKE_4_UP_GPIO_PIN, GPIO_PIN_RESET);
  HAL_GPIO_WritePin(SPIKE_1_GPIO_GROUP, SPIKE_1_DOWN_GPIO_PIN, GPIO_PIN_RESET);
  HAL_GPIO_WritePin(SPIKE_2_GPIO_GROUP, SPIKE_2_DOWN_GPIO_PIN, GPIO_PIN_RESET);
  HAL_GPIO_WritePin(SPIKE_3_GPIO_GROUP, SPIKE_3_DOWN_GPIO_PIN, GPIO_PIN_RESET);
  HAL_GPIO_WritePin(SPIKE_4_GPIO_GROUP, SPIKE_4_DOWN_GPIO_PIN, GPIO_PIN_RESET);


                                                    /* Maoz 2 */
  /*Configure GPIO pins : PA9 PA10 */
  GPIO_InitStruct.Pin = SPIKE_2_UP_GPIO_PIN|SPIKE_2_DOWN_GPIO_PIN;
  ...
  GPIO_InitStruct.Pin = SPIKE_1_DOWN_GPIO_PIN;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(SPIKE_1_GPIO_GROUP, &GPIO_InitStruct);
  ...
  GPIO_InitStruct.Pin = SPIKE_3_DOWN_GPIO_PIN;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(SPIKE_3_GPIO_GROUP, &GPIO_InitStruct);
  ...
  GPIO_InitStruct.Pin = SPIKE_4_DOWN_GPIO_PIN;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(SPIKE_4_GPIO_GROUP, &GPIO_InitStruct);
