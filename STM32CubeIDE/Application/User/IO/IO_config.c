...
void config_elev_GPIO(){
  ...
  HAL_GPIO_WritePin(SPIKE_1_GPIO_GROUP, SPIKE_1_DOWN_GPIO_PIN, !UP_DOWN_LOGIC_LEVEL);
  HAL_GPIO_WritePin(SPIKE_2_GPIO_GROUP, SPIKE_2_DOWN_GPIO_PIN, !UP_DOWN_LOGIC_LEVEL);
  HAL_GPIO_WritePin(SPIKE_3_GPIO_GROUP, SPIKE_3_DOWN_GPIO_PIN, !UP_DOWN_LOGIC_LEVEL);
  HAL_GPIO_WritePin(SPIKE_4_GPIO_GROUP, SPIKE_4_DOWN_GPIO_PIN, !UP_DOWN_LOGIC_LEVEL);
