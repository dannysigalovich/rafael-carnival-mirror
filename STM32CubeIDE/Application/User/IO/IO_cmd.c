...
void elev_down(uint8_t spike_num){
	...
	switch(spike_num){
	case 0:
		DOWN_PULL_ACTION(SPIKE_1_GPIO_GROUP, SPIKE_1_DOWN_GPIO_PIN);
		break;
	case 1:
		DOWN_PULL_ACTION(SPIKE_2_GPIO_GROUP, SPIKE_2_DOWN_GPIO_PIN);
		break;
	case 2:
		DOWN_PULL_ACTION(SPIKE_3_GPIO_GROUP, SPIKE_3_DOWN_GPIO_PIN);
		break;
	case 3:
		DOWN_PULL_ACTION(SPIKE_4_GPIO_GROUP, SPIKE_4_DOWN_GPIO_PIN);
		break;
	}
